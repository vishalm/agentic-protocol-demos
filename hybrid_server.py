...
# Create the MCP server instance that uv run mcp dev can find
mcp = FastMCP("MESH")

# Register MCP tools and resources globally
def _register_mcp_functionality():
...
# Register the MCP functionality
_register_mcp_functionality()

class HybridServer:
    """Hybrid server that runs both MCP and A2A protocols"""
    
    def __init__(self):
        # MCP Server - use the global instance
        self.mcp_server = mcp
